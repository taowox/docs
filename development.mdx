...
<Info>
  **Prerequisite**: Please install Node.js (version 19 or higher) before proceeding. asfasfasfasdf Please upgrade to `docs.json` before proceeding and delete the legacy `mint.json` file.
</Info>
