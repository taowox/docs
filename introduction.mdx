...
The first step to world-class documentation is setting up your editing environments. dddd
...
<CardGroup cols="2">
  <Card title="Customize Style" icon="palette" href="https://mintlify.com/docs/settings/global" cta="Learn more">
